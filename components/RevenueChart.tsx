  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-6">
        <div>
          <h3 className="text-lg font-bold mb-1" style={{ color: colors.textPrimary }}>Revenue by Region</h3>
          <p className="text-sm" style={{ color: colors.textSecondary }}>Monthly breakdown across all regions</p>
        </div>
