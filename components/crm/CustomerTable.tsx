...
export function CustomerTable({ customers, onView, onMessage, onTag }: CustomerTableProps) {
        ...
        <table className="w-full min-w-[600px]">
          <thead>
            <tr style={{ borderBottom: `1px solid ${colors.cardBorder}` }}>
              <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Customer</th>
              <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Email</th>
              ...
              <th className="text-center text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Bookings</th>
              <th className="text-right text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Total Spent</th>
              <th className="text-center text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Segment</th>
              <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Last Contact</th>
            ...
            {customers.map((customer) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-4 px-2">
                    <div className="text-sm" style={{ color: colors.textSecondary }}>{customer.email}</div>
                  </td>
                  <td className="py-4 px-2">
                    <div className="text-sm" style={{ color: colors.textSecondary }}>{customer.region}</div>
                  </td>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-3 text-xs">
                <div>
                  ...
                  <div className="font-medium" style={{ color: colors.textPrimary }}>{customer.region}</div>
                </div>
                <div>
                  <div style={{ color: colors.textSecondary }}>Last Contact</div>
                  <div className="font-mono" style={{ color: colors.textPrimary }}>{customer.lastContact}</div>
                </div>
                <div>
                  <div style={{ color: colors.textSecondary }}>Bookings</div>
                  <div className="font-mono font-bold" style={{ color: colors.textPrimary }}>{customer.totalBookings}</div>
                </div>
                <div>
                  <div style={{ color: colors.textSecondary }}>Total Spent</div>
                  <div className="font-mono font-bold" style={{ color: colors.textPrimary }}>
                    ${customer.totalSpent.toLocaleString()}
                  </div>
                </div>
              </div>
