...
export function SegmentationPanel({ segments, onViewCustomers, onSendCampaign }: SegmentationPanelProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h4 className="text-xs md:text-sm font-bold uppercase tracking-wide mb-4" style={{ color: colors.textPrimary }}>
          Active Segments
        </h4>
        <div className="flex flex-wrap gap-2 md:gap-3">
          {segments.map((segment) => (
            ...
            >
              ...
              <span className="text-xs md:text-sm font-semibold">{segment.name}</span>
              <div 
          ...
          <table className="w-full">
            <thead>
              <tr style={{ borderBottom: `1px solid ${colors.cardBorder}` }}>
                <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Segment Name</th>
                <th className="text-center text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Customers</th>
                <th className="text-right text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Avg. Spend</th>
                <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Top Region</th>
                <th className="text-left text-xs font-semibold uppercase tracking-wide pb-4 px-2" style={{ color: colors.textSecondary }}>Last Campaign</th>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-3 text-xs">
                ...
                <div>
                  ...
                  <div style={{ color: colors.textPrimary }}>{segment.topRegion}</div>
                </div>
                <div>
                  <div style={{ color: colors.textSecondary }}>Last Campaign</div>
                  <div style={{ color: colors.textPrimary }}>{segment.lastCampaign}</div>
                </div>
              </div>
