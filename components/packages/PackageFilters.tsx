...
export function PackageFilters({ 
  ...
  return (
    <div 
      className="rounded-xl p-4 md:p-6 border backdrop-blur-sm lg:sticky lg:top-[96px]"
      style={{
    ...
    >
      <div className="flex items-center gap-2 mb-4 md:mb-6">
        ...
        <h3 className="text-base md:text-lg font-bold" style={{ color: colors.textPrimary }}>Quick Filters</h3>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 text-sm" style={{ color: colors.textPrimary }}>
          ...
          <div className="flex-1 h-1 rounded-full relative" style={{ backgroundColor: `${colors.cardBorder}` }}>
            <div className="absolute h-full rounded-full" style={{ width: '65%', backgroundColor: colors.accent }} />
          </div>
          <span>$10k</span>
        </div>
