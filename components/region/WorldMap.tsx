...
export function WorldMap({ locations, selectedRegion, onRegionSelect }: WorldMapProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        >
          {/* Ocean background */}
          <rect width="800" height="400" fill={colors.background} opacity="0.5" />
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  fill={isSelected ? colors.accent : location.status === 'live' ? colors.gold : colors.textSecondary}
                  ...
                  <div className="text-xs space-y-0.5" style={{ color: colors.textSecondary }}>
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                      <div 
                        ...
                        style={{ backgroundColor: region.status === 'live' ? colors.accent : colors.textSecondary }}
                      />
