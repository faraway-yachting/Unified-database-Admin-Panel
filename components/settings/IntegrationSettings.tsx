            ...
            <div className="flex items-center justify-between pt-4 border-t" style={{ borderColor: colors.cardBorder }}>
              <div className="flex items-center gap-2">
                {integration.connected ? (
                  ...
                  <>
                    <XCircle className="w-4 h-4" style={{ color: colors.textSecondary }} />
              ...
              <button
                ...
                style={{
                  backgroundColor: integration.connected ? colors.background : colors.accent,
                  color: integration.connected ? colors.textPrimary : '#FFFFFF',
                  border: integration.connected ? `1px solid ${colors.cardBorder}` : 'none'
                }}
              >
