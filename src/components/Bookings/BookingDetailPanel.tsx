...
export function BookingDetailPanel({ booking, onClose }: BookingDetailPanelProps) {
  ...
  const yachtImage =
    "https://images.unsplash.com/photo-1683964012191-7cd5617e164d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          >
            ...
            <div className="mb-4 rounded-lg overflow-hidden relative w-full h-32">
              <Image
                src={yachtImage}
                alt={booking.yacht}
                fill
