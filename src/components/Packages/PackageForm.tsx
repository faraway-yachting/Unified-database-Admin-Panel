                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      defaultValue="Experience the ultimate luxury sailing adventure with our premium full-day charter."
                      rows={3}
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {durations.map((duration) => (
                        <button
                          ...
                          className="flex-1 min-w-[80px] px-4 py-2.5 rounded-lg border text-sm font-medium transition-all"
                          style={{
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          style={{
                            backgroundColor: isSelected ? `${colors.accent}20` : `${colors.textSecondary}20`,
                          }}
                        >
                          <Icon className="w-4 h-4" style={{ color: isSelected ? colors.accent : colors.textSecondary }} />
                        </div>
                        <span className="text-sm font-medium" style={{ color: isSelected ? colors.accent : colors.textPrimary }}>
                          {service.name}
                        </span>
                      </button>
                    );
                  ...
                  {addons.map((addon, idx) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        value={`$${addon.price}`}
                        readOnly
                        className="w-24 bg-transparent text-sm font-mono text-right focus:outline-none"
                        style={{ color: colors.textPrimary }}
                      />
                      <button
                        type="button"
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-medium" style={{ color: colors.textSecondary }}>
                        $
                      </span>
                      <input
                        type="text"
                        defaultValue="3,850"
                        className="w-full pl-8 pr-4 py-2.5 rounded-lg border text-sm font-mono focus:outline-none focus:ring-2"
                        style={{
                          backgroundColor: colors.background,
                          borderColor: colors.cardBorder,
                          color: colors.textPrimary,
