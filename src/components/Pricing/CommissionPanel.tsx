    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          >
            {commissions.length} active agents
          </p>
        </div>
        <button
          type="button"
        ...
        <table className="w-full min-w-[600px]">
          <thead>
            <tr style={{ borderBottom: `1px solid ${colors.cardBorder}` }}>
              <th
                className="text-left text-xs font-semibold uppercase tracking-wide pb-3 px-2"
                style={{ color: colors.textSecondary }}
              >
                Agent/Partner
              </th>
              ...
              <th
                className="text-right text-xs font-semibold uppercase tracking-wide pb-3 px-2"
                style={{ color: colors.textSecondary }}
              >
                Earned
              </th>
              <th
                className="text-center text-xs font-semibold uppercase tracking-wide pb-3 px-2"
                style={{ color: colors.textSecondary }}
              >
                Status
              </th>
