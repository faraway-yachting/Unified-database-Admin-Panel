      ...
      >
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ backgroundColor: regionColors.mediterranean }}
          />
          <span
            className="text-xs"
            style={{ color: colors.textSecondary }}
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-3 h-3 rounded"
            style={{ backgroundColor: regionColors.caribbean }}
          />
          <span
            className="text-xs"
            style={{ color: colors.textSecondary }}
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-3 h-3 rounded"
            style={{ backgroundColor: regionColors.pacific }}
          />
          <span
            className="text-xs"
            style={{ color: colors.textSecondary }}
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-3 h-3 rounded"
            style={{ backgroundColor: regionColors.indianOcean }}
          />
          <span
            className="text-xs"
            style={{ color: colors.textSecondary }}
