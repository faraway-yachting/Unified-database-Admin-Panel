  ...
  const yachts: Yacht[] = [
    {
      ...
      type: "Motor Yacht",
      thumbnail:
        "https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=200&h=150&fit=crop",
    ...
    },
    {
      ...
      type: "Catamaran",
      thumbnail:
        "https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=200&h=150&fit=crop",
      availability: "available",
    },
  ];
                ...
                <tbody>
                  {packages.map((pkg) => (
                    ...
                    >
                      ...
                      <td
                        className="py-3 text-sm font-mono font-semibold"
                        style={{ color: colors.textPrimary }}
                      >
                ...
                >
                  <div className="relative h-32 overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: `${getAvailabilityColor(yacht.availability)}90`,
                        color: "#FFFFFF",
                      }}
                    >
                      {yacht.availability.charAt(0).toUpperCase() +
                        yacht.availability.slice(1)}
                    </div>
                  </div>
                  <div className="p-3">
                    <div
