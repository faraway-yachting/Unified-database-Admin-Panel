    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="button"
            className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg border text-sm font-medium transition-all hover:scale-105 focus:outline-none focus:ring-2"
            style={{
              borderColor: colors.cardBorder,
              color: colors.textPrimary,
              backgroundColor: colors.background,
      ...
      >
        ...
        <div className="flex gap-2">
          <button
            type="button"
            className="px-3 py-1.5 rounded-lg border text-sm transition-all hover:scale-105 focus:outline-none focus:ring-2"
            style={{
              borderColor: colors.cardBorder,
              color: colors.textPrimary,
              backgroundColor: colors.background,
          ...
          <button
            type="button"
            className="px-3 py-1.5 rounded-lg text-sm text-white transition-all hover:scale-105 focus:outline-none focus:ring-2"
            style={{
