...
const currencies: Currency[] = [
  {
    ...
    code: "USD",
    rate: 1.0,
    lastUpdated: "Feb 19, 2026 10:30 AM",
    autoUpdate: true,
  },
  {
    id: "C-002",
                  ...
                  <td className="py-4">
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        defaultChecked={currency.autoUpdate}
                      />
                      <div
                        className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"
                        style={{
                          backgroundColor: currency.autoUpdate
                            ? colors.accent
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            style={{ color: colors.textSecondary }}
          >
            When enabled, exchange rates are automatically updated every hour
            from a reliable financial data provider. Manual rates can be set by
            disabling auto-update for specific currencies.
          </div>
        </div>
      </div>
    </div>
