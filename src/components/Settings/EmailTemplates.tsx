          ...
          <div className="space-y-2">
            {templates.map((template) => (
              <button
                ...
                className="w-full p-3 rounded-lg text-left transition-all hover:scale-[1.02] focus:outline-none focus:ring-2"
                style={{
                  backgroundColor:
        ...
        <div className="lg:col-span-2 p-4 md:p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {variableTags.map((tag) => (
                <button
                  ...
                  className="px-2 py-1 rounded text-xs font-mono transition-all hover:scale-105 focus:outline-none focus:ring-2"
                  style={{
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-lg border text-sm font-mono focus:outline-none focus:ring-2"
              style={{
                backgroundColor: colors.background,
                borderColor: colors.cardBorder,
                color: colors.textPrimary,
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            >
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded text-xs font-medium transition-all focus:outline-none focus:ring-2"
                style={{
                  backgroundColor:
                    previewMode === "desktop" ? colors.accent : "transparent",
                  color:
                    previewMode === "desktop" ? "#FFFFFF" : colors.textSecondary,
                }}
              >
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    previewMode === "mobile" ? colors.accent : "transparent",
                  color:
                    previewMode === "mobile" ? "#FFFFFF" : colors.textSecondary,
                }}
              >
          ...
          <div className="flex flex-wrap gap-3">
            <button
              type="button"
              className="px-4 py-2 rounded-lg text-sm font-semibold text-white transition-all hover:scale-105 focus:outline-none focus:ring-2"
              style={{
            ...
            <button
              type="button"
              className="px-4 py-2 rounded-lg border text-sm font-medium transition-all hover:scale-105 focus:outline-none focus:ring-2"
              style={{
                borderColor: colors.cardBorder,
                color: colors.textPrimary,
                backgroundColor: colors.background,
