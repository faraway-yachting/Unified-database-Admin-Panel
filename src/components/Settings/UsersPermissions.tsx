        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px]">
            <thead>
              ...
              >
                <th
                  className="pb-3 pr-4 text-left text-xs font-semibold"
                  style={{ color: colors.textSecondary }}
                >
                  Role
                </th>
              ...
              {permissions.map((perm, index) => (
                <tr
                  ...
                  style={{
                    borderColor: colors.cardBorder,
                    backgroundColor:
                      index % 2 === 0 ? "transparent" : `${colors.background}80`,
                  }}
                >
                  ...
                  {(
                    ...
                    <td key={module} className="py-3 px-2 text-center">
                      <select
                        ...
                        className="px-2 py-1 rounded text-xs border focus:outline-none focus:ring-2"
                        style={{
                          backgroundColor: colors.background,
                          borderColor: colors.cardBorder,
